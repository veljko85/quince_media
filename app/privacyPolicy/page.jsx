  ...
  return (
    <>
      <div className={styles.textPart}>
        ...
        <p>
          Quince Media (“us”, “we”, or “our”) operates the
          https://quincemedia.com/ website (the “Service”).
        </p>
        <p>
          This page informs you of our policies regarding the collection, use,
          and disclosure of personal data when you use our Service and the
          choices you have associated with that data. Our Privacy Policy for
          Quince Media is managed through
          <a
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://quincemedia.com/
        </p>
        ...
        <h2>Use of Data</h2>
        <p>Quince Media uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Quince Media will take all steps reasonably necessary to ensure that
        ...
        <p>
          Quince Media may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Quince Media</li>
          <li>
        ...
        <p>
          ...
          third part's site. We strongly advise you to review the Privacy Policy
        ...
        <ul>
          <li>By email: info@quincemedia.com</li>
        </ul>
      </div>
